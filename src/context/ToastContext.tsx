...
import { IoCloseOutline, IoCheckmarkCircleOutline, IoAlertCircleOutline, IoInformationCircleOutline, IoCartOutline } from "react-icons/io5";
...
const ICONS = {
  success: <IoCheckmarkCircleOutline className="w-4 h-4 text-teal" />,
  error: <IoAlertCircleOutline className="w-4 h-4 text-coral" />,
  info: <IoInformationCircleOutline className="w-4 h-4 text-violet-light" />,
  cart: <IoCartOutline className="w-4 h-4 text-gold" />,
};
