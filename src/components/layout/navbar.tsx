...
import { IoGiftOutline, IoCartOutline, IoMenuOutline, IoCloseOutline, IoPersonOutline, IoLogOutOutline } from "react-icons/io5";
    ...
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-3 backdrop-blur-xl bg-[#0D0F1A]/80 border-b border-[#2E2E38]">
        ...
        <Link href="/" className="flex items-center gap-2 text-white font-bold text-xl">
          <IoGiftOutline size={24} className="text-[#7C3AED]" />
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <Link href="/login">
              ...
              >
                <IoPersonOutline size={16} className="mr-1" />
                Sign In
              </Button>
            </Link>
            <Link href="/register">
          ...
          >
            {mobileOpen ? <IoCloseOutline size={18} /> : <IoMenuOutline size={18} />}
          </button>
        </div>
      </nav>
